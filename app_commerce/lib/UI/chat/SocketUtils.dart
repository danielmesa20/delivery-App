...
class SocketUtils {
  static String _serverIP =
      Platform.isIOS ? 'http://localhost' : 'http://192.168.250.5';
  ...
  sendSingleChatMessage(ChatMessage chatMessageModel, User toChatUser) {
  ...
  checkOnline(ChatMessage chatMessageModel) {
